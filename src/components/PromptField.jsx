...
const PromptField = () => {
    ...
    const handleInputChange=useCallback(()=>{
        if(inputField.current.innerText==='/n')inputField.current.innerHTML='';
  ...
  return (
    ...
    >
      ...
      />
      <Iconbtn icon='send' title='Submit' size='large' classes='ms-auto' variants={promptFieldChildrenVariant} onClick={handleSubmit}/>
